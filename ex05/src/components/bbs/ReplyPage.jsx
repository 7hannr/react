        ...
        {sessionStorage.getItem('uid') ?
          <div className='mb-5'>
            ...
            <div className='text-end mt-2'>
              ...
              variant='light' className='px-5'>등록</Button>
            </div>
          </div>
          :
           <div className='text-end mb-3'>
            <Button onClick={onClickRegister} 
            variant='light' className='px-5'>댓글등록</Button>
           </div>
          }
          {count > 0 &&
          ...
          <div key={reply.rid}>
            <Row>
              <Col className='text-mutes' style={{fontSize:'15px'}}>
              ...
              {uid === reply.uid && !reply.isEdit &&
                <Col className='text-end mb-2'>
                  ...
                  size="sm" variant='light' className='me-2'>수정</Button>
              ...
              {uid === reply.uid && reply.isEdit &&
                <Col className='text-end mb-2'>
                  ...
                  size="sm" variant='light' className='me-2'>저장</Button>
                  <Button onClick={()=>onClickCancel(reply)}
                  size="sm" variant='light'>취소</Button>
                </Col>
              }
            </Row>
