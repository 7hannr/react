...
const InsertPage = () => {
  ...
  return (
    <div className='my-5'>
      <h1 className='text-center mb-5' variant='light'>글쓰기</h1>
        ...
        <Col xs={12} md={10} lg={8}>
          <form onReset={onReset} onSubmit={onSubmit}>
            ...
            <div className='mt-3 text-center'>
              <Button type="submit" className='px-5 me-2' variant='light'>등록</Button>
              <Button type="reset" className='px-5' variant='light'>취소</Button>
            </div>
          </form>
        </Col>
      </Row>
